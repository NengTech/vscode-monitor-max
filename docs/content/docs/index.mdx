...
Monitor Ultra 是一个全面的资源监控工具，旨在帮助你实时跟踪重要的系统指标并提供直观的展现方式。无论你是什么职业，如果你用 VS Code，请不要错过它。
...
- [x] **远程 SSH 资源监控**：你可以在远程 SSH 连接的设备上跟踪重要的系统指标。
...
- 一些商业面板
- [chneau/vscode-resource-monitor](https://github.com/chneau/vscode-resource-monitor)
- [Njanderson/resmon](https://github.com/Njanderson/resmon)

## 为什么要开发这款插件？

为了在使用 VS Code 的 Remote SSH 时提供一种全面的资源监控工具，以便更好地管理和监控服务器的状态。

详细参考：[Remote SSH 资源监控](https://juejin.cn/post/7284885060338155539)
...
来 [Github](https://github.com/nexmoe/vscode-monitor-ultra) 点个 star 或是来 [VS Code 市场](https://marketplace.visualstudio.com/items?itemName=nexmoe.monitor-ultra&ssr=false#review-details) 给个五星好评吧！
