...
export const metadata = {
	title: 'Monitor Ultra',
	description:
		'Monitor Ultra is a VS Code extension that provides powerful system monitoring capabilities, allowing you to easily monitor CPU, memory, network, and disk usage.',
} satisfies Metadata;
		...
		<section className="w-full py-16 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-900">
			<div className="container px-4 md:px-6 flex items-center justify-center flex-col">
				...
				<p className="mb-8 text-xl text-gray-700 dark:text-gray-300">
					立即安装 Monitor Ultra，开启智能资源监控之旅!
				</p>
				<a href="https://marketplace.visualstudio.com/items?itemName=nexmoe.monitor-ultra" target='_blank'>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
					<div className="flex flex-col items-center text-center">
						...
						<p className="text-gray-600 dark:text-gray-400">
							在VS Code扩展市场搜索"Monitor Ultra"并安装
						</p>
					</div>
					<div className="flex flex-col items-center text-center">
						<div className="bg-gray-900 text-white dark:bg-white dark:text-black rounded-full w-12 h-12 flex items-center justify-center mb-4 text-xl font-bold">
			...
			<div className="container px-4 md:px-6 relative z-10">
				...
				<div className="mt-16 flex justify-center">
					<img
						width="1835"
						height="425"
						src="https://github.com/nexmoe/vscode-monitor-ultra/raw/main/assets/screenshot0.png"
						alt="Monitor Ultra 界面预览"
